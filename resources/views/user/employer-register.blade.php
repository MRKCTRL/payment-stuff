...
<div class="col-md-6">
    <div class="card" id="card">
        <div class-header>Employer Registeration</div>
        <form action="#" id="registerationForm" method="post"></form>
        <div class="card-body">
            ...
            <hr>
            <div class="form-group">
                <button class="btn tbn-primary" id="btnRegister">register</button>
            </div>
        </div>
    </div>
    <div id="message"></div>
